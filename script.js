...
const translations = {
  en: {
    ...
    exp1Title: "2026 – Present • ByteDance",
    exp1Role: "Search Operations Specialist",
    exp1Text: "Drive high-volume search operations for TikTok, applying quality standards, policies and operational guidelines to maintain search relevance and accuracy. Analyse quality trends, investigate issues and support process improvements across large-scale digital operations.",

    exp2Title: "2023 – 2025 • Motorsport Events",
    exp2Role: "Account Operations Specialist",
    exp2Text: "Managed CRM workflows, order allocation and supplier coordination for F1 and MotoGP events. Built dashboards, secured VIP client operations, and supported internal systems.",

    exp3Title: "2022 – 2023 • Motorsport Events",
    exp3Role: "Customer Success Executive",
    exp3Text: "Solved complex customer cases, processed B2B ticketing, managed order issues and supported sales teams across major events worldwide.",

    exp4Title: "2019 – 2020 • Google / HCL Technologies",
    exp4Role: "Product Support Engineer",
    exp4Text: "Provided technical troubleshooting for Google products, APIs and internal tooling. Handled escalations and supported engineers with logs, diagnostics and product behaviour.",

    exp5Title: "2018 – 2019 • Fujitsu",
    exp5Role: "Help Desk Analyst (L1 / L2)",
    exp5Text: "Supported 30k+ end users across Europe, diagnosing incidents, access issues, network faults and hardware/software problems.",

    exp6Title: "2017 – 2018 • Instagram / Cognizant",
    exp6Role: "Content Analyst",
    exp6Text: "Analysed content moderation cases, detected behavioural patterns, performed compliance checks and conducted policy investigations.",

    exp7Title: "2015 – 2016 • Meta / Atento",
    exp7Role: "Ads Management Specialist",
    exp7Text: "Supported Meta advertisers with campaign optimisation, billing issues, pixel troubleshooting and platform policy guidance.",

    exp8Title: "2014 – 2015 • Google / Cognizant",
    exp8Role: "Google Ads Specialist",
    exp8Text: "Managed Google Ads optimisation, keyword diagnostics, account audits and advertiser onboarding.",
    eduTitle: "Education & Certifications",
  ...
  es: {
    ...
    exp1Title: "2026 – Actualidad • ByteDance",
    exp1Role: "Especialista en Operaciones de Búsqueda",
    exp1Text: "Gestiono operaciones de búsqueda de alto volumen para TikTok, aplicando estándares de calidad, políticas y procedimientos para mantener la relevancia y precisión de los resultados. Analizo tendencias, investigo problemas y apoyo mejoras de procesos en operaciones digitales a gran escala.",

    exp2Title: "2023 – 2025 • Motorsport Events",
    exp2Role: "Especialista en Operaciones de Cuentas",
    exp2Text: "Gestioné flujos de trabajo en el CRM, asignación de órdenes y coordinación con proveedores para eventos de F1 y MotoGP. Construí dashboards, aseguré operaciones VIP para clientes y di soporte a los sistemas internos.",

    exp3Title: "2022 – 2023 • Motorsport Events",
    exp3Role: "Ejecutivo de Customer Success",
    exp3Text: "Resolví casos complejos de clientes, procesé ticketing B2B, gestioné incidencias de pedidos y apoyé a los equipos de ventas en eventos importantes a nivel mundial.",

    exp4Title: "2019 – 2020 • Google / HCL Technologies",
    exp4Role: "Ingeniero de Soporte de Productos",
    exp4Text: "Brindé soporte técnico para productos de Google, APIs y herramientas internas. Manejé escalaciones y apoyé a ingenieros con registros, diagnósticos y comportamiento del producto.",

    exp5Title: "2018 – 2019 • Fujitsu",
    exp5Role: "Analista de Help Desk (L1 / L2)",
    exp5Text: "Brindé soporte a más de 30.000 usuarios en Europa, diagnosticando incidentes, problemas de acceso, fallas de red y problemas de hardware/software.",

    exp6Title: "2017 – 2018 • Instagram / Cognizant",
    exp6Role: "Analista de Contenido",
    exp6Text: "Analicé casos de moderación de contenido, detecté patrones de comportamiento, realicé verificaciones de cumplimiento e investigué casos de políticas internas.",

    exp7Title: "2015 – 2016 • Meta / Atento",
    exp7Role: "Especialista en Gestión de Anuncios",
    exp7Text: "Brindé soporte a anunciantes de Meta con optimización de campañas, problemas de facturación, resolución de fallos del píxel y orientación sobre políticas de la plataforma.",

    exp8Title: "2014 – 2015 • Google / Cognizant",
    exp8Role: "Especialista en Google Ads",
    exp8Text: "Gestioné la optimización de Google Ads, el diagnóstico de palabras clave, auditorías de cuentas y el onboarding de anunciantes.",
    eduTitle: "Educación y Certificaciones",
  ...
  pt: {
    ...
    exp1Title: "2026 – Presente • ByteDance",
    exp1Role: "Especialista em Operações de Busca",
    exp1Text: "Atuo em operações de busca de alto volume para o TikTok, aplicando padrões de qualidade, políticas e procedimentos para manter a relevância e precisão dos resultados. Analiso tendências, investigo problemas e apoio melhorias de processos em operações digitais de larga escala.",

    exp2Title: "2023 – 2025 • Motorsport Events",
    exp2Role: "Especialista em Operações de Contas",
    exp2Text: "Gerenciei fluxos de trabalho no CRM, alocação de pedidos e coordenação com fornecedores para eventos de F1 e MotoGP. Desenvolvi dashboards, garanti operações VIP para clientes e dei suporte aos sistemas internos.",

    exp3Title: "2022 – 2023 • Motorsport Events",
    exp3Role: "Executivo de Customer Success",
    exp3Text: "Resolvi casos complexos de clientes, processei ticketing B2B, gerenciei problemas de pedidos e dei suporte às equipes de vendas em grandes eventos ao redor do mundo.",

    exp4Title: "2019 – 2020 • Google / HCL Technologies",
    exp4Role: "Engenheiro de Suporte de Produtos",
    exp4Text: "Forneci suporte técnico para produtos do Google, APIs e ferramentas internas. Tratei escalonamentos e apoiei engenheiros com logs, diagnósticos e comportamento dos produtos.",

    exp5Title: "2018 – 2019 • Fujitsu",
    exp5Role: "Analista de Help Desk (L1 / L2)",
    exp5Text: "Dei suporte a mais de 30 mil usuários em toda a Europa, diagnosticando incidentes, problemas de acesso, falhas de rede e problemas de hardware/software.",

    exp6Title: "2017 – 2018 • Instagram / Cognizant",
    exp6Role: "Analista de Conteúdo",
    exp6Text: "Analisei casos de moderação de conteúdo, identifiquei padrões de comportamento, realizei verificações de conformidade e investigações de políticas.",

    exp7Title: "2015 – 2016 • Meta / Atento",
    exp7Role: "Especialista em Gestão de Anúncios",
    exp7Text: "Dei suporte a anunciantes da Meta com otimização de campanhas, problemas de faturamento, troubleshooting do pixel e orientações sobre políticas da plataforma.",

    exp8Title: "2014 – 2015 • Google / Cognizant",
    exp8Role: "Especialista em Google Ads",
    exp8Text: "Gerenciei a otimização do Google Ads, diagnóstico de palavras-chave, auditorias de contas e onboarding de anunciantes.",
    eduTitle: "Educação e Certificações",
