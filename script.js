...
const translations = {
  en: {
    ...
    heroSubtitle: "A Computing (BSc Hons) student with hands-on IT experience, from supporting global tech giants to building my own solutions.",
    viewWork: "🚀 About me",
  ...
  es: {
    ...
    heroSubtitle: "Estudiante de Computing (BSc Hons) con experiencia práctica en TI, desde el soporte a gigantes tecnológicos globales hasta la creación de mis propias soluciones.",
    viewWork: "🚀 Sobre mi",
  ...
  pt: {
    ...
    heroSubtitle: "Estudante de Computing (BSc Hons) com experiência prática em TI, desde o suporte a gigantes globais da tecnologia até a criação das minhas próprias soluções.",
    viewWork: "🚀 Sobre mim",
